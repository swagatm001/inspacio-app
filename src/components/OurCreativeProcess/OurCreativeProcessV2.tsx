    ...
    return (
        <section className="max-w-5xl mx-auto px-4 py-12">
            ...
            <div className="relative">
                {/* Vertical divider */}
                <div className="absolute left-1/2 top-0 h-full w-0.5 bg-gray-200 z-0" />
                {/* vertical circle */}
                <div className="absolute left-1/2 -translate-x-4 -bottom-6 w-8 h-8 rounded-full bg-gradient-to-b from-amber-800 to-white"></div>
                <div className="flex flex-col gap-12 relative z-10">
                    {processConstants2.steps.map((step, idx) => (
                        <div
                            key={uuidv4()}
                            className="flex flex-row items-center justify-between gap-[10vw]"
                        >
                            {idx % 2 === 0 ? (
                                <>
                                    {/* Image left */}
