    ...
    return (
      <div className="flex flex-row md:flex-col gap-4 md:py-10">
        ...
        <div className="flex items-stretch">
          <div
            aria-hidden
            className="hidden md:block w-2 rounded-full self-stretch"
            style={{ background: "linear-gradient(to bottom,#885739,#E0D9C9)" }}
          />
          <div className="flex flex-row md:flex-col gap-20 pl-6 mt-6 mb-6">
            <div>
              <h3 className={clsx(montserrat.className, "text-[#A6836E] font-medium text-lg")}>Location</h3>
              <p className={clsx(satoshi.className, "text-[#3D3834] text-xl")}>32 A, XYZ Building,ABC Street,Indiranagar,Bengaluru - 123456</p>
            </div>
            <div>
              <h3 className={clsx(montserrat.className, "text-[#A6836E] font-medium text-lg")}>React out at</h3>
              <p className={clsx(satoshi.className, "text-[#3D3834] text-xl")}>info@kreativedezine.com</p>
